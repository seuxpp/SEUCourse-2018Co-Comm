...
%% original definition
    ...
    Monte_MAX=10^3    % the times of Monte Carlo,Limited to the computer configuration level, select the number to 10
...
semilogy(SNR_dB,ber_SD,'r-o',SNR_dB,ber_AF,'g-+',SNR_dB,theo_ber_SD,'r-+',SNR_dB,theo_ber_AF,'g-o');%semilogx用半对数坐标绘图,x轴是log10，y是线性的；semilogy用半对数坐标绘图,y轴是log10，x是线性的
legend('actual BER of Direct','actual BER of AF','theoretical BER of Direct','theoretical BER of AF');              
grid on; %增加网格
