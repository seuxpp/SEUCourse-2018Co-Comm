...
%     while (BERVec{7}(2,n) < targetErrors) && (BERVec{7}(3,n) < maxNumTransmissions) 
        ...
        for itx = 1:frameLength
            ...
            cWinvNeum3 = Method_TLI(cW,8,10,2);
...
set(semiplot(4),'Color',[0.850980401039124 0.325490206480026 0.0980392172932625]);%橙色
set(semiplot(5),'Color',[0.850980401039124 0.325490206480026 0.0980392172932625]);%橙色
set(semiplot(6),'Color',[0.929411768913269 0.694117665290833 0.125490203499794]);%黄色
